      ...
      context 'getting allowed list' do
        ...
        context 'first page' do
          it 'should return the correct data' do
            ...
            expected = traffic_cop.allowed[0..8].collect(&:id)
        ...
        context 'last page' do
          it 'should return the correct data' do
            ...
            expected = traffic_cop.allowed[9..].collect(&:id)
            observed = JSON.parse(response.body)['data']['avatar_ids']
        ...
        context 'first page' do
          it 'should return the correct data' do
            get path, params: { list_name: 'banned' },
                      headers: headers(traffic_cop)
            expected = traffic_cop.banned[0..8].collect(&:id)
            observed = JSON.parse(response.body)['data']['avatar_ids']
            expect(observed)
              .to eq(expected)
          end
        ...
        context 'last page' do
          it 'should return the correct data' do
            get path,
                ...
                headers: headers(traffic_cop)
            expected = traffic_cop.banned[9..].collect(&:id)
            observed = JSON.parse(response.body)['data']['avatar_ids']
