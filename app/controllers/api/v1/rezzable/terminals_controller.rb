...
module Api
  module V1
    module Rezzable
      # Controller for Rezzable::Terminal requests from SL
      class TerminalsController < Api::V1::RezzableController
        def give
          ...
          begin
            ...
            InventorySlRequest.give_inventory(@requesting_object.inventory_id,
                                              target_user.avatar_name)
          rescue StandardError => e
            logger.info("Unable to give object: #{e}")
          end
